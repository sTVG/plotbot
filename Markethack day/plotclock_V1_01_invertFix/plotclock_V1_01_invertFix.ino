...
#define LIFT0 1600 // on drawing surface
...
{ 
  ...
  if (last_min != minute()) {
    ...
    lift(0); // make contact with surface
    ...
    number(5, 25, i, 0.9);  // 10's of the hour        
    number(19, 25, (hour()-i*10), 0.9); // units of the Hour
    number(28, 25, 11, 0.9); // draw HH mm seperator ( : )
    ...
    number(34, 25, i, 0.9); //10's 
    number(48, 25, (minute()-i*10), 0.9);
    
    lift(2); // lift very high
    drawTo(74.2, 47.5); // eraser psition
    lift(1); // ready to write ( but not in contact ) 
    last_min = minute();
